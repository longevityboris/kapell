...
CAL_WORK = renders_dir() / "_calibration"   # kapell: re-measured table and probe renders, outside the package
...
def calibrate(renderers: set, lead_in: float, force: bool) -> dict:
    ...
    cal = json.loads(seed.read_text()) if seed.exists() else {}
