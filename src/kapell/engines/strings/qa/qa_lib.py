...
PERFORM = STRINGS.parents[1] / "perform" / "perform.py"
TMP = Path("/tmp/sqa")
RESULTS = QA / "results"
SR = 48000
LIB = Path(__import__("os").environ.get("KAPELL_LIB") or __import__("os").environ.get("PIANO_LIB") or Path.home() / "Music" / "SampleLibraries")
