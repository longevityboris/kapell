...
#
# Large assets live in $KAPELL_LIB (else $PIANO_LIB; default ~/Music/SampleLibraries), never in git:
#
...
LIB="${KAPELL_LIB:-${PIANO_LIB:-$HOME/Music/SampleLibraries}}"
export KAPELL_LIB="$LIB" SAMPLE_LIBRARIES="$LIB" PIANO_LIB="$LIB"
